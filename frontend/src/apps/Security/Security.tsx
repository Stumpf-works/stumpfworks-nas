    ...
    <div className="p-6 h-full overflow-auto bg-gray-50 dark:bg-macos-dark-50">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <div className="p-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">Total Failed Attempts</p>
          ...
          <Card>
            <div className="p-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">Top Failed User</p>
          ...
          {blockedIPs.length === 0 ? (
            <Card>
              <div className="p-8 text-center">
                <p className="text-gray-500 dark:text-gray-400">No blocked IPs</p>
              </div>
            </Card>
          ) : (
