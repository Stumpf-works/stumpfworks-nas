...
type Tab = 'jobs' | 'history' | 'snapshots';

export function BackupManager() {
  const [activeTab, setActiveTab] = useState<Tab>('jobs');

  const tabs = [
    { id: 'jobs' as Tab, name: 'Backup Jobs', icon: '📅' },
    { id: 'history' as Tab, name: 'History', icon: '📜' },
    { id: 'snapshots' as Tab, name: 'Snapshots', icon: '📸' },
  ];
    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-macos-dark-50">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-macos-dark-100">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Manage backup jobs, snapshots, and restore operations
        </p>
      </div>
